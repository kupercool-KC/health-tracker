...
export interface UserProfile {
  ...
  stepGoal?: number;
  /** When true (default), the step goal is compared against steps minus an estimate of steps generated by logged workouts — a run/walk you've already logged as a workout doesn't also count toward "everyday activity" steps. When false, the goal is compared against the raw total. */
  stepsGoalExcludesWorkouts?: boolean;
