...
export const strings = {
  ...
  recordVoice: { en: "Record", he: "הקלטה" },
  stopRecording: { en: "Stop", he: "עצירה" },
  discardRecording: { en: "Discard", he: "מחיקה" },
  transcribing: { en: "Transcribing…", he: "מתמלל…" },
  voiceError: { en: "Couldn't catch that — try again", he: "לא הצלחנו לתמלל — נסו שוב" },
  micDenied: { en: "Microphone access is off", he: "הגישה למיקרופון כבויה" },
  micNoDevice: { en: "No microphone found", he: "לא נמצא מיקרופון" },
  somethingWentWrong: { en: "Something went wrong — tap for details", he: "משהו השתבש — הקש לפרטים" },
  time: { en: "Time", he: "שעה" },
  meal: { en: "Meal", he: "ארוחה" },
  nutritionSourceManual: { en: "You entered these numbers directly.", he: "הזנת את הערכים האלה ישירות." },
  nutritionSourceAdjusted: { en: "You adjusted this value manually.", he: "עדכנת את הערך הזה ידנית." },
  nutritionSourceLabel: { en: "Source", he: "מקור" },
  ...
  photoNotePlaceholder: { en: "Note (optional)", he: "הערה (אופציונלי)" },
  send: { en: "Send", he: "שלח" },
  ...
  pickerFreeTextPlaceholder: { en: "e.g. with olive oil and rice", he: "לדוגמה: עם שמן זית ואורז" },
